...
class _PurpleBox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final size = MediaQuery.of(context).size; //obtengo el tamaño total de la pantalla en una variable
...
class Imagen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: const [
        Expanded(flex: 2, child: SizedBox(height: 10,)),//creo una caja que ocupa todo el tamaño disponible.
       Align(
